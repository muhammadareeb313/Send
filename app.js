...
firebase.database().ref("cart").push(obj)
  ...
  <div class="card" style="width: 18rem;  margin-top: 10px; border: 3px solid skyblue;">
    ...
    <h5 style=" border-bottom: 1px solid skyblue;"  class="card-title">${a.select +"<br>"}</h5>
      ...
      <button onclick='addToCart("${a.select}","${a.price}","${a.restraunt}","${a.url}","${a.Delivery}")' class="btn btn-primary">ADD TO CART</button> 
  ...
  <div class="card" style="width: 18rem;  margin-top: 10px; border: 3px solid skyblue;">
    ...
    <h5 style=" border-bottom: 1px solid skyblue;"  class="card-title">${r.rejcategory +"<br>"}</h5>
      ...
      <p style=" border-bottom: 1px solid skyblue;"  class="card-text">${r.rejprice}</p>
       ...
       <button onclick='rejected("${r.rejimg}","${r.rejcategory}","${r.rejrestraunt}","${r.rejprice}","${r.rejdelivery}")' class="btn btn-primary">Rejected</button>
    </div>
  </div> `
   })
}
...
let delv=()=>{
  ...
  firebase.database().ref('delivered').on("child_added",function(data){
    ...
    delive.innerHTML+=`
  <div class="card" style="width: 18rem;  margin-top: 10px; border: 3px solid skyblue;">
    <img src="${d.rejimg}" style="width: 100%; class="card-img-top" alt="...">
    <div class="card-body">
    <h5 style=" border-bottom: 1px solid skyblue;"  class="card-title">${d.rejcategory +"<br>"}</h5>
      <h5 style=" border-bottom: 1px solid skyblue;"  class="card-title">${d.rejrestraunt +"<br>"}</h5>
      <p style=" border-bottom: 1px solid skyblue;"  class="card-text">${d.rejprice}</p>
       <p style=" border-bottom: 1px solid skyblue;"  class="card-text">${d.rejdelivery}</p>
    </div>
  </div> `
   })
}
